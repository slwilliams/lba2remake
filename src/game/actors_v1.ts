...
import { ActorFlags, ActorProps } from './actors';

interface ActorFlagsV1 extends ActorFlags {
    spriteAnim3DNumber: boolean;
}

interface ActorPropsV1 extends ActorProps {
    index: number;
    sceneIndex: number;
